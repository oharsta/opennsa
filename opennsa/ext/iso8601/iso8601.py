...
class Test(unittest.TestCase):
    def test(self):
        ...
        self.assertEqual(parse('12:04:23.45'), time(12, 4, 23, 450000))

        # combined
        self.assertEqual(parse('2008-09-03T20:56:35.450686'), datetime(2008, 9, 3, 20, 56, 35, 450686))
        self.assertEqual(parse('2008-09-03T20:56:35.450686Z'), datetime(2008, 9, 3, 20, 56, 35, 450686, TimeZone(timedelta())))
        self.assertEqual(parse('2008-09-03T20:56:35.45Z'), datetime(2008, 9, 3, 20, 56, 35, 450000, TimeZone(timedelta())))
        self.assertEqual(parse('2008-09-03T20:56:35.450686+01'), datetime(2008, 9, 3, 20, 56, 35, 450686, TimeZone(timedelta(minutes=60))))
        self.assertEqual(parse('2008-09-03T20:56:35.45+01'), datetime(2008, 9, 3, 20, 56, 35, 450000, TimeZone(timedelta(minutes=60))))
        self.assertEqual(parse('2008-09-03T20:56:35.450686+0100'), datetime(2008, 9, 3, 20, 56, 35, 450686, TimeZone(timedelta(minutes=60))))
        self.assertEqual(parse('2008-09-03T20:56:35.450686+01:30'), datetime(2008, 9, 3, 20, 56, 35, 450686, TimeZone(timedelta(minutes=60 + 30))))
        self.assertEqual(parse('2008-09-03T20:56:35.450686-01:30'), datetime(2008, 9, 3, 20, 56, 35, 450686, TimeZone(timedelta(minutes=-(60 + 30)))))
